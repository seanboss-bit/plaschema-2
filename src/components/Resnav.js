...
const Resnav = ({ setSideNavDisplay, sideNavDisplay }) => {
      ...
      <div className="navbars" id={sideNavDisplay ? "active" : "activenot"}>
        <div className="search-container">
          ...
          <div className="res-search">
            ...
            <input
              type="text"
              className={search ? "res-input active" : "res-input"}
              placeholder="Search"
            />
          </div>
        ...
        <div className="user-menu">
          ...
          <div className="messages-nav">
            ...
            <ul
              className="notification-data3"
              id={messageToggle ? "active" : ""}
            >
              <li className="notification-header">
                <div className="new-notify">
                  <h5>5 New </h5>
